...
public class PublicTransport extends Service {
    ...
    private ResidentialBuilding RB;
    ...
    public void buildTransport() {
    	...
    	if(!(GameMap.isAreaAvailable(location.getX(),location.getY(),area))) {
    		System.err.println("Selected Location is already occupied");
    	}
    	
    	char[][] road = new char[length][breadth]; // Declaring a new 2d road array.
